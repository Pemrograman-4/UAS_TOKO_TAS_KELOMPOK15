...
import 'package:tas/ui/detail_tas.dart';
...
class TasView extends StatelessWidget {
  final String apiUrl = UrlServer + "tas/get";
  void showSnakbar(BuildContext context, Message, color) {
    final snackBar = SnackBar(content: Text(Message), backgroundColor: color);
    ScaffoldMessenger.of(context).showSnackBar(snackBar);
    List<dynamic>? fecthDataTas;
  }
    ...
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (BuildContext context) =>
                detail_tas_view(id:id, warna: warna,deskrispi:deskripsi,
                    merk: merk,size: size)));
